...
def app():
    # Read data
    data_path = 'data/mercados_precios-mercados-tiempo-real'
    ...
    if granularity == 'Daily':
        ...
        data_filtered = data_filtered.groupby('date').mean().reset_index()
    ...
    fig1 = px.line(
        ...
        x = 'date', 
        y = 'value', 
        title = f'Electricity demand evolution in {title_text}'
    )
